...
public final class TermuxPreferenceConstants {
    ...
    public static final class TERMUX_APP {
        ...
        /**
         * Defines the key for whether terminal auto scroll to bottom on new output is disabled or not.
         */
        public static final String KEY_TERMINAL_AUTO_SCROLL_DISABLED = "terminal_auto_scroll_disabled";
        public static final boolean DEFAULT_VALUE_TERMINAL_AUTO_SCROLL_DISABLED = false;
