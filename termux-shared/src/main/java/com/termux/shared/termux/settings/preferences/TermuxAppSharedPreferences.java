...
public class TermuxAppSharedPreferences extends AppSharedPreferences {
    ...
    public boolean isTerminalAutoScrollDisabled() {
        return SharedPreferenceUtils.getBoolean(mSharedPreferences, TERMUX_APP.KEY_TERMINAL_AUTO_SCROLL_DISABLED, TERMUX_APP.DEFAULT_VALUE_TERMINAL_AUTO_SCROLL_DISABLED);
    }

    public void setTerminalAutoScrollDisabled(boolean value) {
        SharedPreferenceUtils.setBoolean(mSharedPreferences, TERMUX_APP.KEY_TERMINAL_AUTO_SCROLL_DISABLED, value, false);
    }
