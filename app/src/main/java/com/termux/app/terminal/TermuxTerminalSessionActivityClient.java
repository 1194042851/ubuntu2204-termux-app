...
import com.termux.app.UbuntuRootUtils;
...
public class TermuxTerminalSessionActivityClient extends TermuxTerminalSessionClientBase {
    ...
    public void setCurrentSession(TerminalSession session) {
        ...
        // Apply auto scroll setting from preferences
        if (session.getEmulator() != null) {
            boolean autoScrollDisabled = mActivity.getPreferences().isTerminalAutoScrollDisabled();
            session.getEmulator().setAutoScrollDisabled(autoScrollDisabled);
        }
